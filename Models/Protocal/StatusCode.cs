...
namespace MmWizard.Protocol
{
    ...
    public class StatusCode
    {
        ...
        /// 状态码描述
        /// </summary>
        public string msg { get { return _msg.ToLower(); } set { _msg = value; } }
        ...
        /// 超时
        /// </summary>
        public static StatusCode TimeOut
        {
            get { return new StatusCode() { code = (int)Code.TimeOut, msg = Code.TimeOut.ToString() }; }
        }
